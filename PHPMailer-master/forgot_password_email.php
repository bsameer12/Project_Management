    ...
    try {
        ...
        $mail->Body    = "
                            ...
                            <body style='font-family: Arial, sans-serif; text-align: center;'>
                                ...
                                <!-- Text -->
                                <p style='color: #666; margin-bottom: 20px;'>Hello $name,<br> You recently requested to reset your password for your HudderFoods account. Use the following verification code to reset your password:</p>
