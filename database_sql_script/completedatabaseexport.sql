--------------------------------------------------------
--  File created - Sunday-May-26-2024   
--------------------------------------------------------
DROP SEQUENCE "HUDDERFOODS"."APEX$_WS_SEQ";
DROP SEQUENCE "HUDDERFOODS"."CONTACT_ID_SEQ";
DROP SEQUENCE "HUDDERFOODS"."DEMO_CUST_SEQ";
DROP SEQUENCE "HUDDERFOODS"."DEMO_ORDER_ITEMS_SEQ";
DROP SEQUENCE "HUDDERFOODS"."DEMO_ORD_SEQ";
DROP SEQUENCE "HUDDERFOODS"."DEMO_PROD_SEQ";
DROP SEQUENCE "HUDDERFOODS"."DEPT_SEQ";
DROP SEQUENCE "HUDDERFOODS"."EMP_SEQ";
DROP SEQUENCE "HUDDERFOODS"."QUERY_ID_SEQ";
DROP SEQUENCE "HUDDERFOODS"."SEQ_ADMIN";
DROP SEQUENCE "HUDDERFOODS"."SEQ_CART";
DROP SEQUENCE "HUDDERFOODS"."SEQ_CATEGORY";
DROP SEQUENCE "HUDDERFOODS"."SEQ_CUSTOMER";
DROP SEQUENCE "HUDDERFOODS"."SEQ_DISCOUNT";
DROP SEQUENCE "HUDDERFOODS"."SEQ_ORDER";
DROP SEQUENCE "HUDDERFOODS"."SEQ_PAYMENT";
DROP SEQUENCE "HUDDERFOODS"."SEQ_PRODUCT";
DROP SEQUENCE "HUDDERFOODS"."SEQ_REPORT";
DROP SEQUENCE "HUDDERFOODS"."SEQ_REVIEW";
DROP SEQUENCE "HUDDERFOODS"."SEQ_SHOP";
DROP SEQUENCE "HUDDERFOODS"."SEQ_SLOT";
DROP SEQUENCE "HUDDERFOODS"."SEQ_TRADER";
DROP SEQUENCE "HUDDERFOODS"."SEQ_USER";
DROP SEQUENCE "HUDDERFOODS"."SEQ_USER_ID";
DROP SEQUENCE "HUDDERFOODS"."SEQ_WISHLIST";
DROP SEQUENCE "HUDDERFOODS"."USER_ID_SEQ";
DROP SEQUENCE "HUDDERFOODS"."USER_ID_SEQE";
DROP SEQUENCE "HUDDERFOODS"."SEQ_ADMIN";
DROP SEQUENCE "HUDDERFOODS"."SEQ_CART";
DROP SEQUENCE "HUDDERFOODS"."SEQ_SLOT";
DROP SEQUENCE "HUDDERFOODS"."CONTACT_ID_SEQ";
...
DROP SEQUENCE "HUDDERFOODS"."SEQ_TRADER";
DROP SEQUENCE "HUDDERFOODS"."SEQ_WISHLIST";
DROP TABLE "HUDDERFOODS"."ADMIN" cascade constraints;
DROP TABLE "HUDDERFOODS"."CART" cascade constraints;
DROP TABLE "HUDDERFOODS"."CART_ITEM" cascade constraints;
DROP TABLE "HUDDERFOODS"."COLLECTION_SLOT" cascade constraints;
DROP TABLE "HUDDERFOODS"."CONTACTUS" cascade constraints;
DROP TABLE "HUDDERFOODS"."CUSTOMER" cascade constraints;
DROP TABLE "HUDDERFOODS"."DISCOUNT" cascade constraints;
DROP TABLE "HUDDERFOODS"."HTMLDB_PLAN_TABLE" cascade constraints;
DROP TABLE "HUDDERFOODS"."HUDDER_USER" cascade constraints;
DROP TABLE "HUDDERFOODS"."ORDER_DETAILS" cascade constraints;
DROP TABLE "HUDDERFOODS"."ORDER_PRODUCT" cascade constraints;
DROP TABLE "HUDDERFOODS"."PAYMENT" cascade constraints;
DROP TABLE "HUDDERFOODS"."PRODUCT" cascade constraints;
DROP TABLE "HUDDERFOODS"."PRODUCT_CATEGORY" cascade constraints;
DROP TABLE "HUDDERFOODS"."PRODUCT_REPORT" cascade constraints;
DROP TABLE "HUDDERFOODS"."REPORT" cascade constraints;
DROP TABLE "HUDDERFOODS"."REVIEW" cascade constraints;
DROP TABLE "HUDDERFOODS"."SHOP" cascade constraints;
DROP TABLE "HUDDERFOODS"."TRADER" cascade constraints;
DROP TABLE "HUDDERFOODS"."WISHLIST" cascade constraints;
DROP TABLE "HUDDERFOODS"."WISHLIST_ITEM" cascade constraints;
DROP TABLE "HUDDERFOODS"."HUDDER_USER" cascade constraints;
DROP TABLE "HUDDERFOODS"."CUSTOMER" cascade constraints;
DROP TABLE "HUDDERFOODS"."CART" cascade constraints;
DROP TABLE "HUDDERFOODS"."PRODUCT" cascade constraints;
...
DROP TABLE "HUDDERFOODS"."SHOP" cascade constraints;
DROP TABLE "HUDDERFOODS"."TRADER" cascade constraints;
DROP PACKAGE "HUDDERFOODS"."SAMPLE_DATA_PKG";
DROP PACKAGE "HUDDERFOODS"."SAMPLE_PKG";
DROP PACKAGE "HUDDERFOODS"."SAMPLE_DATA_PKG";
DROP PACKAGE "APEX_190200"."WWV_FLOW_GLOBAL";
DROP PACKAGE "HUDDERFOODS"."SAMPLE_PKG";
DROP PACKAGE BODY "HUDDERFOODS"."SAMPLE_DATA_PKG";
DROP PACKAGE BODY "HUDDERFOODS"."SAMPLE_PKG";
DROP SYNONYM "PUBLIC"."DUAL";
DROP SYNONYM "PUBLIC"."DBMS_SQL";
DROP SYNONYM "PUBLIC"."APEX_ERROR";
DROP SYNONYM "PUBLIC"."DBMS_LOB";
DROP SYNONYM "PUBLIC"."PLITBLM";
DROP SYNONYM "PUBLIC"."WWV_FLOW_API";
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "HUDDERFOODS"."APEX$_WS_SEQ"  MINVALUE 100 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 100 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence CONTACT_ID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."CONTACT_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence DEMO_CUST_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."DEMO_CUST_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 100 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence DEMO_ORDER_ITEMS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."DEMO_ORDER_ITEMS_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 160 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence DEMO_ORD_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."DEMO_ORD_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 11 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence DEMO_PROD_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."DEMO_PROD_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 100 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence DEPT_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."DEPT_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 50 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence EMP_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."EMP_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 8000 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence QUERY_ID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."QUERY_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 10 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_ADMIN
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."SEQ_ADMIN"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 401 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_CART
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."SEQ_CART"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 901 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_CATEGORY
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."SEQ_CATEGORY"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1105 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_CUSTOMER
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."SEQ_CUSTOMER"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 301 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_DISCOUNT
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."SEQ_DISCOUNT"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1200 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_ORDER
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."SEQ_ORDER"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1405 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_PAYMENT
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."SEQ_PAYMENT"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1305 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_PRODUCT
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."SEQ_PRODUCT"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 625 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_REPORT
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."SEQ_REPORT"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 700 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_REVIEW
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."SEQ_REVIEW"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 809 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_SHOP
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."SEQ_SHOP"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 505 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_SLOT
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."SEQ_SLOT"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1505 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_TRADER
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."SEQ_TRADER"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 205 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_USER
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."SEQ_USER"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 8 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_USER_ID
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."SEQ_USER_ID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_WISHLIST
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."SEQ_WISHLIST"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1001 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence USER_ID_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."USER_ID_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence USER_ID_SEQE
--------------------------------------------------------

   CREATE SEQUENCE  "HUDDERFOODS"."USER_ID_SEQE"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_ADMIN
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "HUDDERFOODS"."ADMIN" 
   (	"ADMIN_ID" NUMBER(*,0), 
	"USER_ID" NUMBER(*,0)
  ...
  TABLESPACE "APEX_1500846206436447" ;
--------------------------------------------------------
--  DDL for Table CART
--------------------------------------------------------

  CREATE TABLE "HUDDERFOODS"."CART" 
   (	"CART_ID" NUMBER(*,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "HUDDERFOODS"."CART_ITEM" 
   (	"NO_OF_PRODUCTS" NUMBER(*,0), 
	"CART_ID" NUMBER(*,0), 
	"PRODUCT_ID" NUMBER(*,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "HUDDERFOODS"."COLLECTION_SLOT" 
   (	"SLOT_ID" NUMBER(*,0), 
	"SLOT_DATE" DATE, 
	"SLOT_TIME" VARCHAR2(255 BYTE), 
	"SLOT_DAY" VARCHAR2(10 BYTE), 
	"ORDER_PRODUCT_ID" NUMBER(*,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "HUDDERFOODS"."CONTACTUS" 
   (	"QUERY_ID" NUMBER(10,0), 
	...
	"VERIFIED_STATUS" NUMBER(1,0) DEFAULT 0
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE TABLE "HUDDERFOODS"."CUSTOMER" 
   (	"CUSTOMER_ID" NUMBER(*,0), 
	"CUSTOMER_DATE_JOINED" DATE, 
	"VERIFICATION_CODE" NUMBER(*,0), 
	"DATE_UPDATED" DATE, 
	"VERIFIED_CUSTOMER" NUMBER(1,0), 
	"USER_ID" NUMBER(*,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "HUDDERFOODS"."DISCOUNT" 
   (	"DISCOUNT_ID" NUMBER(*,0), 
	"DISCOUNT_OCCASSION" VARCHAR2(100 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "HUDDERFOODS"."HTMLDB_PLAN_TABLE" 
  ...
  TABLESPACE "APEX_1500846206436447" ;
--------------------------------------------------------
--  DDL for Table HUDDER_USER
--------------------------------------------------------

  CREATE TABLE "HUDDERFOODS"."HUDDER_USER" 
   (	"USER_ID" NUMBER(*,0), 
	"FIRST_NAME" VARCHAR2(100 BYTE), 
	"LAST_NAME" VARCHAR2(100 BYTE), 
	...
	"USER_AGE" NUMBER(*,0), 
	"USER_GENDER" CHAR(8 BYTE), 
	"USER_PASSWORD" VARCHAR2(100 BYTE), 
	"USER_PROFILE_PICTURE" VARCHAR2(255 BYTE), 
	"USER_TYPE" VARCHAR2(10 BYTE), 
	"USER_CONTACT_NO" NUMBER(*,0), 
	"USER_DOB" DATE
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
--------------------------------------------------------
  ...
  CREATE TABLE "HUDDERFOODS"."ORDER_DETAILS" 
   (	"PRODUCT_ID" NUMBER, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "HUDDERFOODS"."ORDER_PRODUCT" 
   (	"ORDER_PRODUCT_ID" NUMBER(*,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "HUDDERFOODS"."PAYMENT" 
   (	"PAYMENT_ID" NUMBER(*,0), 
	"PAYMENT_DATE" DATE, 
...
--------------------------------------------------------
  ...
  CREATE TABLE "HUDDERFOODS"."PRODUCT" 
   (	"PRODUCT_ID" NUMBER(*,0), 
	"PRODUCT_NAME" VARCHAR2(100 BYTE), 
	"PRODUCT_DESCRIPTION" VARCHAR2(500 BYTE), 
	"PRODUCT_PRICE" NUMBER(*,0), 
	"PRODUCT_QUANTITY" NUMBER(*,0), 
	"STOCK_AVAILABLE" VARCHAR2(100 BYTE), 
	"IS_DISABLED" NUMBER, 
	"MAX_ORDER" NUMBER(*,0), 
	"ALLERGY_INFORMATION" VARCHAR2(500 BYTE), 
	"PRODUCT_PICTURE" VARCHAR2(255 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "HUDDERFOODS"."PRODUCT_CATEGORY" 
   (	"CATEGORY_ID" NUMBER(*,0), 
	"CATEGORY_TYPE" VARCHAR2(100 BYTE), 
	"CATEGORY_IMAGE" VARCHAR2(255 BYTE)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE TABLE "HUDDERFOODS"."PRODUCT_REPORT" 
   (	"REPORT_ID" NUMBER(*,0), 
	"PRODUCT_ID" NUMBER(*,0)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
...
--------------------------------------------------------
  ...
  CREATE TABLE "HUDDERFOODS"."REPORT" 
   (	"REPORT_ID" NUMBER(*,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "HUDDERFOODS"."REVIEW" 
   (	"REVIEW_ID" NUMBER(*,0), 
	"REVIEW_DATE" DATE, 
	"REVIEW_SCORE" NUMBER(*,0), 
	"FEEDBACK" VARCHAR2(500 BYTE), 
	"PRODUCT_ID" NUMBER(*,0), 
	"USER_ID" NUMBER(*,0), 
	"REVIEW_PROCIDED" NUMBER, 
	"ORDER_ID" NUMBER, 
	"CUSTOMER_ID" NUMBER
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
...
--------------------------------------------------------
  ...
  CREATE TABLE "HUDDERFOODS"."SHOP" 
   (	"SHOP_ID" NUMBER(*,0), 
	"SHOP_NAME" VARCHAR2(100 BYTE), 
	"SHOP_DESCRIPTION" VARCHAR2(500 BYTE), 
	"USER_ID" NUMBER(*,0), 
	"VERIFIED_SHOP" NUMBER(1,0), 
	"SHOP_PROFILE" VARCHAR2(255 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "HUDDERFOODS"."TRADER" 
   (	"TRADER_ID" NUMBER(*,0), 
	"TRADER_TYPE" VARCHAR2(100 BYTE), 
	"SHOP_NAME" VARCHAR2(100 BYTE), 
	"VERIFICATION_STATUS" NUMBER(1,0), 
	"USER_ID" NUMBER(*,0), 
	"PROFILE_PICTURE" VARCHAR2(255 BYTE), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "HUDDERFOODS"."WISHLIST" 
  ...
  TABLESPACE "APEX_1500846206436447" ;
--------------------------------------------------------
--  DDL for Table WISHLIST_ITEM
--------------------------------------------------------

  CREATE TABLE "HUDDERFOODS"."WISHLIST_ITEM" 
   (	"WISHLIST_ID" NUMBER(*,0), 
	"PRODUCT_ID" NUMBER(*,0)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
...
--------------------------------------------------------
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447" ;
REM INSERTING into HUDDERFOODS.ADMIN
SET DEFINE OFF;
Insert into HUDDERFOODS.ADMIN (ADMIN_ID,USER_ID) values (400,1);
REM INSERTING into HUDDERFOODS.CART
SET DEFINE OFF;
Insert into HUDDERFOODS.CART (CART_ID,CUSTOMER_ID,ORDER_PRODUCT_ID) values (900,300,604);
REM INSERTING into HUDDERFOODS.CART_ITEM
SET DEFINE OFF;
REM INSERTING into HUDDERFOODS.COLLECTION_SLOT
SET DEFINE OFF;
Insert into HUDDERFOODS.COLLECTION_SLOT (SLOT_ID,SLOT_DATE,SLOT_TIME,SLOT_DAY,ORDER_PRODUCT_ID,LOCATION) values (1501,to_date('29-MAY-24','DD-MON-RR'),'13:00-16:00','Wednesday',1401,'Location 2');
Insert into HUDDERFOODS.COLLECTION_SLOT (SLOT_ID,SLOT_DATE,SLOT_TIME,SLOT_DAY,ORDER_PRODUCT_ID,LOCATION) values (1500,to_date('03-JUN-24','DD-MON-RR'),'10:00-13:00','Monday',1400,'Location 2');
Insert into HUDDERFOODS.COLLECTION_SLOT (SLOT_ID,SLOT_DATE,SLOT_TIME,SLOT_DAY,ORDER_PRODUCT_ID,LOCATION) values (1502,to_date('31-MAY-24','DD-MON-RR'),'16:00-19:00','Friday',1402,'Location 2');
Insert into HUDDERFOODS.COLLECTION_SLOT (SLOT_ID,SLOT_DATE,SLOT_TIME,SLOT_DAY,ORDER_PRODUCT_ID,LOCATION) values (1503,to_date('29-MAY-24','DD-MON-RR'),'16:00-19:00','Wednesday',1403,'Location 3');
Insert into HUDDERFOODS.COLLECTION_SLOT (SLOT_ID,SLOT_DATE,SLOT_TIME,SLOT_DAY,ORDER_PRODUCT_ID,LOCATION) values (1504,to_date('31-MAY-24','DD-MON-RR'),'10:00-13:00','Friday',1404,'Location 2');
REM INSERTING into HUDDERFOODS.CONTACTUS
SET DEFINE OFF;
REM INSERTING into HUDDERFOODS.CUSTOMER
SET DEFINE OFF;
Insert into HUDDERFOODS.CUSTOMER (CUSTOMER_ID,CUSTOMER_DATE_JOINED,VERIFICATION_CODE,DATE_UPDATED,VERIFIED_CUSTOMER,USER_ID,PROFILE_PICTURE) values (300,to_date('26-MAY-24','DD-MON-RR'),927168,to_date('26-MAY-24','DD-MON-RR'),1,7,'665264e6c24a3.jpg');
REM INSERTING into HUDDERFOODS.DISCOUNT
SET DEFINE OFF;
REM INSERTING into HUDDERFOODS.HTMLDB_PLAN_TABLE
SET DEFINE OFF;
REM INSERTING into HUDDERFOODS.HUDDER_USER
SET DEFINE OFF;
Insert into HUDDERFOODS.HUDDER_USER (USER_ID,FIRST_NAME,LAST_NAME,USER_ADDRESS,USER_EMAIL,USER_AGE,USER_GENDER,USER_PASSWORD,USER_PROFILE_PICTURE,USER_TYPE,USER_CONTACT_NO,USER_DOB) values (2,'Sameer','Basnet','Bhaktapur','basnetsamir1234@gmail.com',20,'male    ','7348e261a87e711c5f45399dcbec63b8','665252afb018c.jpg','trader',9824305625,to_date('12-OCT-03','DD-MON-RR'));
Insert into HUDDERFOODS.HUDDER_USER (USER_ID,FIRST_NAME,LAST_NAME,USER_ADDRESS,USER_EMAIL,USER_AGE,USER_GENDER,USER_PASSWORD,USER_PROFILE_PICTURE,USER_TYPE,USER_CONTACT_NO,USER_DOB) values (6,'Senish','Basnet','Biratneghar','rewat25473@fincainc.com',24,'male    ','7348e261a87e711c5f45399dcbec63b8','6652629187461.jpg','trader',9826756428,to_date('23-JUN-99','DD-MON-RR'));
Insert into HUDDERFOODS.HUDDER_USER (USER_ID,FIRST_NAME,LAST_NAME,USER_ADDRESS,USER_EMAIL,USER_AGE,USER_GENDER,USER_PASSWORD,USER_PROFILE_PICTURE,USER_TYPE,USER_CONTACT_NO,USER_DOB) values (1,'Sameer','Basnet','Kathmandu','hudderfoods@gmail.com',21,'male    ','7348e261a87e711c5f45399dcbec63b8','profile.jpg','Admin',9824305625,to_date('10-DEC-03','DD-MON-RR'));
Insert into HUDDERFOODS.HUDDER_USER (USER_ID,FIRST_NAME,LAST_NAME,USER_ADDRESS,USER_EMAIL,USER_AGE,USER_GENDER,USER_PASSWORD,USER_PROFILE_PICTURE,USER_TYPE,USER_CONTACT_NO,USER_DOB) values (3,'Sabin','Khanal','Lalitpur','doggydon942@gmail.com',20,'male    ','7348e261a87e711c5f45399dcbec63b8','665257d6219d7.jpg','trader',9849415278,to_date('22-JAN-04','DD-MON-RR'));
Insert into HUDDERFOODS.HUDDER_USER (USER_ID,FIRST_NAME,LAST_NAME,USER_ADDRESS,USER_EMAIL,USER_AGE,USER_GENDER,USER_PASSWORD,USER_PROFILE_PICTURE,USER_TYPE,USER_CONTACT_NO,USER_DOB) values (4,'Selika','Basnet','Belbari','basnetsamir2001@gmail.com',18,'female  ','7348e261a87e711c5f45399dcbec63b8','66525bc651dbe.jpg','trader',9817345345,to_date('26-OCT-05','DD-MON-RR'));
Insert into HUDDERFOODS.HUDDER_USER (USER_ID,FIRST_NAME,LAST_NAME,USER_ADDRESS,USER_EMAIL,USER_AGE,USER_GENDER,USER_PASSWORD,USER_PROFILE_PICTURE,USER_TYPE,USER_CONTACT_NO,USER_DOB) values (5,'Dinesh','Ayer','Lalitpur','rewat35473@fincainc.com',17,'other   ','7348e261a87e711c5f45399dcbec63b8','66525f1e55f41.jpg','trader',9849415278,to_date('23-NOV-06','DD-MON-RR'));
Insert into HUDDERFOODS.HUDDER_USER (USER_ID,FIRST_NAME,LAST_NAME,USER_ADDRESS,USER_EMAIL,USER_AGE,USER_GENDER,USER_PASSWORD,USER_PROFILE_PICTURE,USER_TYPE,USER_CONTACT_NO,USER_DOB) values (7,'Sam','Basnet','Biratneghar','bsameer22@tbc.edu.np',21,'male    ','7348e261a87e711c5f45399dcbec63b8','665264e6c24a3.jpg','customer',9826756428,to_date('23-JAN-03','DD-MON-RR'));
REM INSERTING into HUDDERFOODS.ORDER_DETAILS
SET DEFINE OFF;
Insert into HUDDERFOODS.ORDER_DETAILS (PRODUCT_ID,TRADER_USER_ID,ORDER_PRODUCT_ID,PRODUCT_QTY,PRODUCT_PRICE) values (604,2,1400,3,9);
Insert into HUDDERFOODS.ORDER_DETAILS (PRODUCT_ID,TRADER_USER_ID,ORDER_PRODUCT_ID,PRODUCT_QTY,PRODUCT_PRICE) values (601,2,1400,3,10);
Insert into HUDDERFOODS.ORDER_DETAILS (PRODUCT_ID,TRADER_USER_ID,ORDER_PRODUCT_ID,PRODUCT_QTY,PRODUCT_PRICE) values (602,2,1400,3,5);
Insert into HUDDERFOODS.ORDER_DETAILS (PRODUCT_ID,TRADER_USER_ID,ORDER_PRODUCT_ID,PRODUCT_QTY,PRODUCT_PRICE) values (623,6,1401,2,1);
Insert into HUDDERFOODS.ORDER_DETAILS (PRODUCT_ID,TRADER_USER_ID,ORDER_PRODUCT_ID,PRODUCT_QTY,PRODUCT_PRICE) values (622,6,1401,4,14);
Insert into HUDDERFOODS.ORDER_DETAILS (PRODUCT_ID,TRADER_USER_ID,ORDER_PRODUCT_ID,PRODUCT_QTY,PRODUCT_PRICE) values (614,4,1402,2,100);
Insert into HUDDERFOODS.ORDER_DETAILS (PRODUCT_ID,TRADER_USER_ID,ORDER_PRODUCT_ID,PRODUCT_QTY,PRODUCT_PRICE) values (613,4,1402,2,90);
Insert into HUDDERFOODS.ORDER_DETAILS (PRODUCT_ID,TRADER_USER_ID,ORDER_PRODUCT_ID,PRODUCT_QTY,PRODUCT_PRICE) values (618,5,1403,15,45);
Insert into HUDDERFOODS.ORDER_DETAILS (PRODUCT_ID,TRADER_USER_ID,ORDER_PRODUCT_ID,PRODUCT_QTY,PRODUCT_PRICE) values (609,3,1404,15,20);
REM INSERTING into HUDDERFOODS.ORDER_PRODUCT
SET DEFINE OFF;
Insert into HUDDERFOODS.ORDER_PRODUCT (ORDER_PRODUCT_ID,NO_OF_PRODUCT,ORDER_STATUS,TOTAL_PRICE,SLOT_ID,CART_ID,ORDER_DATE,ORDER_TIME,DISCOUNT_AMOUNT,CUSTOMER_ID) values (1400,9,1,72,1500,900,to_date('26-MAY-24','DD-MON-RR'),to_timestamp('26-MAY-24 04.10.33.284000000 AM','DD-MON-RR HH.MI.SSXFF AM'),0,300);
Insert into HUDDERFOODS.ORDER_PRODUCT (ORDER_PRODUCT_ID,NO_OF_PRODUCT,ORDER_STATUS,TOTAL_PRICE,SLOT_ID,CART_ID,ORDER_DATE,ORDER_TIME,DISCOUNT_AMOUNT,CUSTOMER_ID) values (1401,6,1,58,1501,900,to_date('26-MAY-24','DD-MON-RR'),to_timestamp('26-MAY-24 04.24.58.286000000 AM','DD-MON-RR HH.MI.SSXFF AM'),0,300);
Insert into HUDDERFOODS.ORDER_PRODUCT (ORDER_PRODUCT_ID,NO_OF_PRODUCT,ORDER_STATUS,TOTAL_PRICE,SLOT_ID,CART_ID,ORDER_DATE,ORDER_TIME,DISCOUNT_AMOUNT,CUSTOMER_ID) values (1402,4,1,380,1502,900,to_date('26-MAY-24','DD-MON-RR'),to_timestamp('26-MAY-24 04.27.18.249000000 AM','DD-MON-RR HH.MI.SSXFF AM'),0,300);
Insert into HUDDERFOODS.ORDER_PRODUCT (ORDER_PRODUCT_ID,NO_OF_PRODUCT,ORDER_STATUS,TOTAL_PRICE,SLOT_ID,CART_ID,ORDER_DATE,ORDER_TIME,DISCOUNT_AMOUNT,CUSTOMER_ID) values (1403,15,1,675,1503,900,to_date('26-MAY-24','DD-MON-RR'),to_timestamp('26-MAY-24 04.28.33.631000000 AM','DD-MON-RR HH.MI.SSXFF AM'),0,300);
Insert into HUDDERFOODS.ORDER_PRODUCT (ORDER_PRODUCT_ID,NO_OF_PRODUCT,ORDER_STATUS,TOTAL_PRICE,SLOT_ID,CART_ID,ORDER_DATE,ORDER_TIME,DISCOUNT_AMOUNT,CUSTOMER_ID) values (1404,15,1,300,1504,900,to_date('26-MAY-24','DD-MON-RR'),to_timestamp('26-MAY-24 04.31.24.385000000 AM','DD-MON-RR HH.MI.SSXFF AM'),0,300);
REM INSERTING into HUDDERFOODS.PAYMENT
SET DEFINE OFF;
Insert into HUDDERFOODS.PAYMENT (PAYMENT_ID,PAYMENT_DATE,PAYMENT_TYPE,PAYMENT_AMOUNT,CUSTOMER_ID,ORDER_PRODUCT_ID) values (1301,to_date('26-MAY-24','DD-MON-RR'),'PayPal',1,300,1401);
Insert into HUDDERFOODS.PAYMENT (PAYMENT_ID,PAYMENT_DATE,PAYMENT_TYPE,PAYMENT_AMOUNT,CUSTOMER_ID,ORDER_PRODUCT_ID) values (1300,to_date('26-MAY-24','DD-MON-RR'),'PayPal',1,300,1400);
Insert into HUDDERFOODS.PAYMENT (PAYMENT_ID,PAYMENT_DATE,PAYMENT_TYPE,PAYMENT_AMOUNT,CUSTOMER_ID,ORDER_PRODUCT_ID) values (1302,to_date('26-MAY-24','DD-MON-RR'),'PayPal',4,300,1402);
Insert into HUDDERFOODS.PAYMENT (PAYMENT_ID,PAYMENT_DATE,PAYMENT_TYPE,PAYMENT_AMOUNT,CUSTOMER_ID,ORDER_PRODUCT_ID) values (1303,to_date('26-MAY-24','DD-MON-RR'),'PayPal',7,300,1403);
Insert into HUDDERFOODS.PAYMENT (PAYMENT_ID,PAYMENT_DATE,PAYMENT_TYPE,PAYMENT_AMOUNT,CUSTOMER_ID,ORDER_PRODUCT_ID) values (1304,to_date('26-MAY-24','DD-MON-RR'),'PayPal',3,300,1404);
REM INSERTING into HUDDERFOODS.PRODUCT
SET DEFINE OFF;
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (615,'Blue Cheese','Savor the rich, tangy flavor of our premium Blue Cheese. With its creamy texture and bold, pungent taste, it&#039;s perfect for salads, sauces, or enjoying on its own. Elevate your dishes with this gourmet delight!',5,55,'yes',1,null,'Contains milk. Made in a facility that processes tree nuts, soy, and other dairy products. Please consult with staff for specific allergy concerns or detailed ingredient information.','66525fa6868b8.jpeg',to_date('26-MAY-24','DD-MON-RR'),to_date('26-MAY-24','DD-MON-RR'),1102,5,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (616,'Chicken Sausage','Enjoy our flavorful Chicken Sausage, crafted from premium chicken and seasoned with a blend of herbs and spices. Perfect for grilling, saut&eacute;ing, or adding to your favorite recipes. A delicious, versatile choice for any meal!',6,23,'yes',1,null,'Contains chicken. Made in a facility that processes wheat, soy, and other meats. Please consult with staff for specific allergy concerns or detailed ingredient information.','6652600d5bdf0.jpeg',to_date('26-MAY-24','DD-MON-RR'),to_date('26-MAY-24','DD-MON-RR'),1102,5,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (617,'Brie Cheese','Experience the creamy, buttery taste of our Brie Cheese. With its soft, edible rind and rich, smooth interior, this French delicacy is perfect for spreading on bread, pairing with fruits, or enjoying on its own. Its mild, earthy flavor and luxurious texture make it a standout addition to any cheese platter or culinary creation.',9,66,'yes',1,null,'Contains milk. Made in a facility that processes tree nuts, soy, and other dairy products. Please consult with staff for specific allergy concerns or detailed ingredient information.','66526086b65b2.jpeg',to_date('26-MAY-24','DD-MON-RR'),to_date('26-MAY-24','DD-MON-RR'),1102,5,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (618,'Mozarello','Indulge in our fresh Mozzarella, known for its soft, creamy texture and mild, milky flavor. Perfect for salads, pizzas, and sandwiches, it melts beautifully and enhances any dish with its delicious taste.',45,40,'yes',1,null,'Contains milk. Made in a facility that processes tree nuts, soy, and other dairy products. Please consult with staff for specific allergy concerns or detailed ingredient information.','665260f4bac9f.jpeg',to_date('26-MAY-24','DD-MON-RR'),to_date('26-MAY-24','DD-MON-RR'),1102,5,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (619,'Quail Eggs','Discover the gourmet appeal of our Quail Eggs, known for their delicate flavor and rich nutrition. Perfect for appetizers, salads, or gourmet recipes. A unique and elegant addition to any meal!',17,88,'yes',1,null,'Contains eggs. Produced in a facility that handles soy, wheat, and other allergens. Please consult with staff for specific allergy concerns or detailed ingredient information.','66526151ac4e7.jpeg',to_date('26-MAY-24','DD-MON-RR'),to_date('26-MAY-24','DD-MON-RR'),1102,5,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (620,'BlackBerry','Enjoy the sweet, tangy flavor of our fresh Blackberries. Bursting with juiciness, they&#039;re perfect for snacking, baking, or adding to your favorite dishes. Rich in vitamins and antioxidants for a healthy treat!',3,77,'yes',1,null,'Blackberries are generally allergen-free but are processed in a facility that handles nuts and other fruits. Please consult with staff for specific allergy concerns or detailed ingredient information.','6652633d1bbfc.jpeg',to_date('26-MAY-24','DD-MON-RR'),to_date('26-MAY-24','DD-MON-RR'),1104,6,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (621,'Guava','Savor the tropical taste of our fresh Guavas, known for their sweet, fragrant flavor and juicy, tender flesh. Perfect for snacking, smoothies, or adding to salads. Packed with vitamins and antioxidants for a healthy treat!',1,200,'yes',1,null,'Guava is generally allergen-free but processed in a facility that handles nuts and other fruits. Please consult with staff for specific allergy concerns or detailed ingredient information.','6652639813087.jpeg',to_date('26-MAY-24','DD-MON-RR'),to_date('26-MAY-24','DD-MON-RR'),1100,6,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (622,'Watermelon','Refresh with our juicy Watermelon, bursting with sweet, hydrating flavor. Perfect for hot days, snacks, or adding to salads. Packed with vitamins and antioxidants for a delicious, healthy treat!',14,246,'yes',1,null,'Watermelon is generally allergen-free but processed in a facility that handles nuts and other fruits. Please consult with staff for specific allergy concerns or detailed ingredient information.','665263eb59cc2.jpeg',to_date('26-MAY-24','DD-MON-RR'),to_date('26-MAY-24','DD-MON-RR'),1104,6,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (623,'Lemon','Brighten your dishes with our fresh Lemons, known for their vibrant, tangy flavor and zesty aroma. Perfect for cooking, baking, or adding a refreshing twist to drinks. Packed with vitamin C for a healthy boost!',1,398,'yes',1,null,'Lemons are generally allergen-free but processed in a facility that handles nuts and other fruits. Please consult with staff for specific allergy concerns or detailed ingredient information.','6652644715517.jpeg',to_date('26-MAY-24','DD-MON-RR'),to_date('26-MAY-24','DD-MON-RR'),1104,6,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (624,'Kiwi','Enjoy the sweet and tangy flavor of our fresh Kiwis, with their vibrant green flesh and tiny black seeds. Perfect for snacking, smoothies, or adding to salads. Rich in vitamins, fiber, and antioxidants for a healthy treat!',3,300,'yes',1,null,'Contains kiwi. Processed in a facility that handles nuts and other fruits. Please consult with staff for specific allergy concerns or detailed ingredient information.','66526490411cd.jpeg',to_date('26-MAY-24','DD-MON-RR'),to_date('26-MAY-24','DD-MON-RR'),1100,6,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (603,'French Macaron','Enjoy our delicate French Macarons, featuring a crisp, airy shell with a chewy center, filled with a variety of rich, flavorful creams. Perfect for a sophisticated treat or special occasion indulgence!',3,30,'yes',1,null,'Contains almonds, eggs, and milk. Made in a facility that also processes wheat, peanuts, and other tree nuts. Please consult with staff for specific allergy concerns or detailed ingredient information.','665256072a7df.png',to_date('25-MAY-24','DD-MON-RR'),to_date('25-MAY-24','DD-MON-RR'),1100,2,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (600,'Cinnammon Roll','Indulge in our freshly baked cinnamon rolls, featuring a soft, fluffy dough swirled with a rich cinnamon-sugar blend, and topped with a creamy, melt-in-your-mouth glaze. Perfect for breakfast or a sweet treat!',10,20,'yes',1,null,'Contains wheat, milk, eggs, and soy. Produced in a facility that also processes nuts and tree nuts. Please consult with staff if you have any specific allergy concerns.','665254ac27a83.jpeg',to_date('25-MAY-24','DD-MON-RR'),to_date('25-MAY-24','DD-MON-RR'),1100,2,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (601,'Apple Strudel','Experience the delight of our Apple Strudel, filled with tender, spiced apples and raisins, wrapped in flaky pastry, and dusted with powdered sugar. Perfect for dessert or a sweet snack anytime!',10,6,'yes',1,null,'Contains wheat, milk, and eggs. May contain traces of nuts and soy, as it is made in a facility that processes these allergens. Please consult with staff for detailed allergy concerns and information.','6652552f78dcf.jpeg',to_date('25-MAY-24','DD-MON-RR'),to_date('25-MAY-24','DD-MON-RR'),1100,2,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (602,'Lemon Bars','Savor our tangy Lemon Bars, featuring a zesty lemon filling atop a buttery shortbread crust, dusted with powdered sugar. Perfectly balanced between sweet and tart, ideal for any occasion or snack!',5,57,'yes',1,null,'Contains wheat, milk, and eggs. Made in a facility that processes nuts and soy. Please consult with staff if you have specific allergy concerns or need detailed information about ingredients.','6652559696896.jpeg',to_date('25-MAY-24','DD-MON-RR'),to_date('25-MAY-24','DD-MON-RR'),1100,2,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (604,'Trifle','Delight in our classic Trifle, a layered dessert of moist sponge cake, creamy custard, and fresh fruit, topped with a dollop of whipped cream and a sprinkle of nuts. Perfectly balanced with sweet and fruity flavors, it&#039;s an irresistible treat for any occasion!

',9,87,'yes',1,null,'Contains wheat, milk, eggs, and nuts. Made in a facility that processes soy and other tree nuts. Please consult with staff for specific allergy concerns or detailed ingredient information.','665256840ad96.jpeg',to_date('25-MAY-24','DD-MON-RR'),to_date('25-MAY-24','DD-MON-RR'),1100,2,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (605,'Bacon','Savor our premium Bacon, perfectly cured and smoked for a rich, savory flavor. Crispy and delicious, it&#039;s ideal for breakfast, sandwiches, or adding a tasty twist to your favorite dishes. Enjoy every bite!',10,45,'yes',1,null,'Contains pork. Made in a facility that processes soy and wheat. Please consult with staff for specific allergy concerns or detailed ingredient information.','6652587a33456.jpeg',to_date('25-MAY-24','DD-MON-RR'),to_date('25-MAY-24','DD-MON-RR'),1101,3,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (606,'Chicken Liver','Enjoy our fresh Chicken Liver, rich in flavor and nutrients. Perfect for saut&eacute;ing, making p&acirc;t&eacute;, or adding to your favorite recipes. Versatile and delicious, it&#039;s a gourmet ingredient for any meal.',13,29,'yes',1,null,'Contains chicken. Processed in a facility that handles soy, wheat, and other meats. Please consult with staff for specific allergy concerns or detailed ingredient information.','665258e58c6e8.jpeg',to_date('25-MAY-24','DD-MON-RR'),to_date('25-MAY-24','DD-MON-RR'),1101,3,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (607,'Pork Chop','Indulge in our succulent Pork Chops, expertly cut and perfect for grilling, baking, or pan-searing. With a tender, juicy texture and rich flavor, these chops are ideal for creating a delicious, hearty meal that everyone will love. Perfect for any occasion!',15,51,'yes',1,null,'Contains pork. Processed in a facility that handles soy, wheat, and other meats. Please consult with staff for specific allergy concerns or detailed ingredient information.','6652595a2edbb.jpeg',to_date('25-MAY-24','DD-MON-RR'),to_date('25-MAY-24','DD-MON-RR'),1101,3,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (608,'Lamb Chop','Experience the exquisite taste of our Lamb Chops, expertly cut and perfect for grilling, roasting, or pan-searing. With tender, juicy meat and a rich, savory flavor, these chops are ideal for creating a gourmet meal that will impress any guest. Perfect for any special occasion!',19,49,'yes',1,null,'Contains lamb. Processed in a facility that handles soy, wheat, and other meats. Please consult with staff for specific allergy concerns or detailed ingredient information.','665259da15904.jpeg',to_date('25-MAY-24','DD-MON-RR'),to_date('25-MAY-24','DD-MON-RR'),1101,3,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (609,'Frozen Whole Chicken','Our Frozen Whole Chicken is perfect for roasting, grilling, or slow cooking. Carefully selected and flash-frozen to lock in freshness and flavor, it&#039;s a versatile and delicious addition to any meal. Enjoy tender, juicy meat every time!',20,65,'yes',1,null,'Contains chicken. Processed in a facility that handles soy, wheat, and other meats. Please consult with staff for specific allergy concerns or detailed ingredient information.','66525a44853a6.jpeg',to_date('25-MAY-24','DD-MON-RR'),to_date('25-MAY-24','DD-MON-RR'),1101,3,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (610,'Atlantic Salmon','Enjoy our premium Atlantic Salmon, known for its rich, buttery flavor and tender texture. Perfect for grilling, baking, or pan-searing, it&#039;s a delicious and healthy choice for any meal. Savor the freshness!',30,30,'yes',1,null,'Contains fish (salmon). Processed in a facility that also handles shellfish and other seafood. Please consult with staff for specific allergy concerns or detailed ingredient information.','66525c69e843b.jpeg',to_date('25-MAY-24','DD-MON-RR'),to_date('25-MAY-24','DD-MON-RR'),1103,4,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (611,'Lobster Tail','Indulge in our succulent Lobster Tail, known for its sweet, tender meat. Perfect for grilling, broiling, or baking, it&#039;s a luxurious addition to any meal, offering a gourmet dining experience at home.',40,15,'yes',1,null,'Contains shellfish (lobster). Processed in a facility that also handles fish, crustaceans, and other seafood. Please consult with staff for specific allergy concerns or detailed ingredient information.','66525ce118030.jpeg',to_date('25-MAY-24','DD-MON-RR'),to_date('25-MAY-24','DD-MON-RR'),1103,4,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (612,'French Crab Raw','Discover the exquisite flavor of our French Crab, known for its sweet, delicate meat. Perfect for steaming, boiling, or incorporating into your favorite recipes. Enjoy a taste of gourmet seafood at home!',60,9,'yes',1,null,'Contains shellfish (crab). Processed in a facility that also handles fish, crustaceans, and other seafood. Please consult with staff for specific allergy concerns or detailed ingredient information.','66525d429c20c.jpeg',to_date('25-MAY-24','DD-MON-RR'),to_date('25-MAY-24','DD-MON-RR'),1103,4,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (613,'Sea Prawns','Delight in our fresh Sea Prawns, known for their firm, juicy texture and sweet flavor. Perfect for grilling, saut&eacute;ing, or adding to your favorite dishes. Versatile and delicious, ideal for any seafood lover!',90,43,'yes',1,null,'Contains shellfish (prawns). Processed in a facility that also handles fish, crustaceans, and other seafood. Please consult with staff for specific allergy concerns or detailed ingredient information.','66525db2b54a9.jpeg',to_date('25-MAY-24','DD-MON-RR'),to_date('25-MAY-24','DD-MON-RR'),1103,4,1);
Insert into HUDDERFOODS.PRODUCT (PRODUCT_ID,PRODUCT_NAME,PRODUCT_DESCRIPTION,PRODUCT_PRICE,PRODUCT_QUANTITY,STOCK_AVAILABLE,IS_DISABLED,MAX_ORDER,ALLERGY_INFORMATION,PRODUCT_PICTURE,PRODUCT_ADDED_DATE,PRODUCT_UPDATE_DATE,CATEGORY_ID,USER_ID,ADMIN_VERIFIED) values (614,'Shrimp','Enjoy our fresh Shrimp, renowned for their tender, succulent texture and sweet flavor. Perfect for grilling, saut&eacute;ing, or incorporating into various dishes. Versatile and delicious for any seafood recipe!',100,58,'yes',1,null,'Contains shellfish (shrimp). Processed in a facility that also handles fish, crustaceans, and other seafood. Please consult with staff for specific allergy concerns or detailed ingredient information.','66525e2165833.jpeg',to_date('25-MAY-24','DD-MON-RR'),to_date('25-MAY-24','DD-MON-RR'),1103,4,1);
REM INSERTING into HUDDERFOODS.PRODUCT_CATEGORY
SET DEFINE OFF;
Insert into HUDDERFOODS.PRODUCT_CATEGORY (CATEGORY_ID,CATEGORY_TYPE,CATEGORY_IMAGE) values (1100,'Bakery','66525128cad5b.jpeg');
Insert into HUDDERFOODS.PRODUCT_CATEGORY (CATEGORY_ID,CATEGORY_TYPE,CATEGORY_IMAGE) values (1101,'Butcher','6652513b91147.jpeg');
Insert into HUDDERFOODS.PRODUCT_CATEGORY (CATEGORY_ID,CATEGORY_TYPE,CATEGORY_IMAGE) values (1102,'Delicatessen','6652517109f27.jpeg');
Insert into HUDDERFOODS.PRODUCT_CATEGORY (CATEGORY_ID,CATEGORY_TYPE,CATEGORY_IMAGE) values (1103,'Fish Monger','6652519ff104f.jpeg');
Insert into HUDDERFOODS.PRODUCT_CATEGORY (CATEGORY_ID,CATEGORY_TYPE,CATEGORY_IMAGE) values (1104,'Green Grocer','665251c73a1fe.jpeg');
REM INSERTING into HUDDERFOODS.PRODUCT_REPORT
SET DEFINE OFF;
REM INSERTING into HUDDERFOODS.REPORT
SET DEFINE OFF;
REM INSERTING into HUDDERFOODS.REVIEW
SET DEFINE OFF;
Insert into HUDDERFOODS.REVIEW (REVIEW_ID,REVIEW_DATE,REVIEW_SCORE,FEEDBACK,PRODUCT_ID,USER_ID,REVIEW_PROCIDED,ORDER_ID,CUSTOMER_ID) values (803,to_date('26-MAY-24','DD-MON-RR'),5,'The lemons were incredibly fresh and zesty, adding the perfect tangy flavor to my dishes!',623,7,1,1401,300);
Insert into HUDDERFOODS.REVIEW (REVIEW_ID,REVIEW_DATE,REVIEW_SCORE,FEEDBACK,PRODUCT_ID,USER_ID,REVIEW_PROCIDED,ORDER_ID,CUSTOMER_ID) values (804,to_date('26-MAY-24','DD-MON-RR'),5,'The watermelon was exceptionally juicy and sweet, making it a refreshing and delicious treat!',622,7,1,1401,300);
Insert into HUDDERFOODS.REVIEW (REVIEW_ID,REVIEW_DATE,REVIEW_SCORE,FEEDBACK,PRODUCT_ID,USER_ID,REVIEW_PROCIDED,ORDER_ID,CUSTOMER_ID) values (800,to_date('26-MAY-24','DD-MON-RR'),5,'The trifle was a delightful treat! The layers of moist sponge cake, creamy custard, and fresh fruit were perfectly balanced. A delicious, indulgent dessert!',604,7,1,1400,300);
Insert into HUDDERFOODS.REVIEW (REVIEW_ID,REVIEW_DATE,REVIEW_SCORE,FEEDBACK,PRODUCT_ID,USER_ID,REVIEW_PROCIDED,ORDER_ID,CUSTOMER_ID) values (801,to_date('26-MAY-24','DD-MON-RR'),5,'The apple strudel was divine! The pastry was perfectly flaky, and the spiced apple filling was deliciously sweet and warm. A wonderful treat for any time of day!',601,7,1,1400,300);
Insert into HUDDERFOODS.REVIEW (REVIEW_ID,REVIEW_DATE,REVIEW_SCORE,FEEDBACK,PRODUCT_ID,USER_ID,REVIEW_PROCIDED,ORDER_ID,CUSTOMER_ID) values (802,to_date('26-MAY-24','DD-MON-RR'),5,'The lemon bars were absolutely delicious! The perfect balance of tart and sweet, with a buttery crust and zesty lemon filling. A refreshing and delightful treat!',602,7,1,1400,300);
Insert into HUDDERFOODS.REVIEW (REVIEW_ID,REVIEW_DATE,REVIEW_SCORE,FEEDBACK,PRODUCT_ID,USER_ID,REVIEW_PROCIDED,ORDER_ID,CUSTOMER_ID) values (805,to_date('26-MAY-24','DD-MON-RR'),5,'The shrimp were fresh and succulent, with a sweet flavor that was perfect for grilling and sauting!',614,7,1,1402,300);
Insert into HUDDERFOODS.REVIEW (REVIEW_ID,REVIEW_DATE,REVIEW_SCORE,FEEDBACK,PRODUCT_ID,USER_ID,REVIEW_PROCIDED,ORDER_ID,CUSTOMER_ID) values (806,to_date('26-MAY-24','DD-MON-RR'),4,'The sea prawns were firm and flavorful, adding a delicious touch to our seafood dishes!',613,7,1,1402,300);
Insert into HUDDERFOODS.REVIEW (REVIEW_ID,REVIEW_DATE,REVIEW_SCORE,FEEDBACK,PRODUCT_ID,USER_ID,REVIEW_PROCIDED,ORDER_ID,CUSTOMER_ID) values (807,to_date('26-MAY-24','DD-MON-RR'),3,'The mozzarella was fresh and creamy, perfect for salads and pizzas. A delightful, milky flavor!',618,7,1,1403,300);
Insert into HUDDERFOODS.REVIEW (REVIEW_ID,REVIEW_DATE,REVIEW_SCORE,FEEDBACK,PRODUCT_ID,USER_ID,REVIEW_PROCIDED,ORDER_ID,CUSTOMER_ID) values (808,to_date('26-MAY-24','DD-MON-RR'),2,'The frozen whole chicken was tender and flavorful, perfect for roasting and grilling. Excellent quality!',609,7,1,1404,300);
REM INSERTING into HUDDERFOODS.SHOP
SET DEFINE OFF;
Insert into HUDDERFOODS.SHOP (SHOP_ID,SHOP_NAME,SHOP_DESCRIPTION,USER_ID,VERIFIED_SHOP,SHOP_PROFILE,SHOP_CATEGORY_ID,REGISTRATION_NO) values (500,'Brakery World','We sell the best bakery items with high quality ingredients.',2,1,'665252afb0501.jpeg',1100,5544669871230);
Insert into HUDDERFOODS.SHOP (SHOP_ID,SHOP_NAME,SHOP_DESCRIPTION,USER_ID,VERIFIED_SHOP,SHOP_PROFILE,SHOP_CATEGORY_ID,REGISTRATION_NO) values (504,'Veg World','Welcome to Veg World, your one-stop shop for the freshest, highest-quality vegetables. From leafy greens to root vegetables, we offer a wide variety to meet all your culinary needs. Eat fresh, live healthy!',6,1,'66526291875f4.jpeg',1104,9876543210);
Insert into HUDDERFOODS.SHOP (SHOP_ID,SHOP_NAME,SHOP_DESCRIPTION,USER_ID,VERIFIED_SHOP,SHOP_PROFILE,SHOP_CATEGORY_ID,REGISTRATION_NO) values (501,'Meat World','&quot;Meat World: Your Ultimate Destination for Fresh, Quality Meats and Exceptional Service!&quot;',3,1,'665257d621b8d.jpeg',1101,112299873456);
Insert into HUDDERFOODS.SHOP (SHOP_ID,SHOP_NAME,SHOP_DESCRIPTION,USER_ID,VERIFIED_SHOP,SHOP_PROFILE,SHOP_CATEGORY_ID,REGISTRATION_NO) values (502,'Sea Food World','Welcome to Sea Food World, your go-to destination for the freshest, finest seafood. From fish and shrimp to oysters and more, we offer a wide variety of high-quality, delicious seafood to delight every palate.',4,1,'66525bc651f5e.jpeg',1103,1213141516171809);
Insert into HUDDERFOODS.SHOP (SHOP_ID,SHOP_NAME,SHOP_DESCRIPTION,USER_ID,VERIFIED_SHOP,SHOP_PROFILE,SHOP_CATEGORY_ID,REGISTRATION_NO) values (503,'Sweet Worlds','Welcome to Sweet Worlds, your ultimate destination for exquisite delicacies. From decadent chocolates and gourmet candies to artisanal pastries and delightful confections, we offer a wide array of sweet treats to satisfy every craving. Indulge in the finest sweets and discover a world of flavors!',5,1,'66525f1e56061.jpeg',1102,112299873456);
REM INSERTING into HUDDERFOODS.TRADER
SET DEFINE OFF;
Insert into HUDDERFOODS.TRADER (TRADER_ID,TRADER_TYPE,SHOP_NAME,VERIFICATION_STATUS,USER_ID,PROFILE_PICTURE,VERIFICATION_CODE,VERFIED_ADMIN,VERIFICATION_SEND) values (200,'1100','Brakery World',1,2,'665252afb018c.jpg',69653,1,1);
Insert into HUDDERFOODS.TRADER (TRADER_ID,TRADER_TYPE,SHOP_NAME,VERIFICATION_STATUS,USER_ID,PROFILE_PICTURE,VERIFICATION_CODE,VERFIED_ADMIN,VERIFICATION_SEND) values (204,'1104','Veg World',1,6,'6652629187461.jpg',147589,1,1);
Insert into HUDDERFOODS.TRADER (TRADER_ID,TRADER_TYPE,SHOP_NAME,VERIFICATION_STATUS,USER_ID,PROFILE_PICTURE,VERIFICATION_CODE,VERFIED_ADMIN,VERIFICATION_SEND) values (201,'1101','Meat World',1,3,'665257d6219d7.jpg',671178,1,1);
Insert into HUDDERFOODS.TRADER (TRADER_ID,TRADER_TYPE,SHOP_NAME,VERIFICATION_STATUS,USER_ID,PROFILE_PICTURE,VERIFICATION_CODE,VERFIED_ADMIN,VERIFICATION_SEND) values (202,'1103','Sea Food World',1,4,'66525bc651dbe.jpg',301668,1,1);
Insert into HUDDERFOODS.TRADER (TRADER_ID,TRADER_TYPE,SHOP_NAME,VERIFICATION_STATUS,USER_ID,PROFILE_PICTURE,VERIFICATION_CODE,VERFIED_ADMIN,VERIFICATION_SEND) values (203,'1102','Sweet Worlds',1,5,'66525f1e55f41.jpg',692667,1,1);
REM INSERTING into HUDDERFOODS.WISHLIST
SET DEFINE OFF;
Insert into HUDDERFOODS.WISHLIST (WISHLIST_ID,WISHLIST_CREATED_DATE,WISHLIST_UPDATED_DATE,CUSTOMER_ID) values (1000,to_date('26-MAY-24','DD-MON-RR'),to_date('26-MAY-24','DD-MON-RR'),300);
REM INSERTING into HUDDERFOODS.WISHLIST_ITEM
SET DEFINE OFF;
--------------------------------------------------------
--  DDL for Index PK_ADMIN_ID
--------------------------------------------------------

  CREATE UNIQUE INDEX "HUDDERFOODS"."PK_ADMIN_ID" ON "HUDDERFOODS"."ADMIN" ("ADMIN_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447" ;
--------------------------------------------------------
--  DDL for Index PK_CART_ID
--------------------------------------------------------

  CREATE UNIQUE INDEX "HUDDERFOODS"."PK_CART_ID" ON "HUDDERFOODS"."CART" ("CART_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447" ;
--------------------------------------------------------
--  DDL for Index PK_CATEGORY_ID
--------------------------------------------------------

  CREATE UNIQUE INDEX "HUDDERFOODS"."PK_CATEGORY_ID" ON "HUDDERFOODS"."PRODUCT_CATEGORY" ("CATEGORY_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HUDDERFOODS"."PK_COLLECTION_SLOT" ON "HUDDERFOODS"."COLLECTION_SLOT" ("SLOT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HUDDERFOODS"."PK_CUSTOMER_ID" ON "HUDDERFOODS"."CUSTOMER" ("CUSTOMER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447" ;
--------------------------------------------------------
--  DDL for Index PK_DISCOUNT_ID
--------------------------------------------------------

  CREATE UNIQUE INDEX "HUDDERFOODS"."PK_DISCOUNT_ID" ON "HUDDERFOODS"."DISCOUNT" ("DISCOUNT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447" ;
--------------------------------------------------------
--  DDL for Index PK_ORDER_PRODUCT_ID
--------------------------------------------------------

  CREATE UNIQUE INDEX "HUDDERFOODS"."PK_ORDER_PRODUCT_ID" ON "HUDDERFOODS"."ORDER_PRODUCT" ("ORDER_PRODUCT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HUDDERFOODS"."PK_PAYMENT_ID" ON "HUDDERFOODS"."PAYMENT" ("PAYMENT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HUDDERFOODS"."PK_PRODUCT_ID" ON "HUDDERFOODS"."PRODUCT" ("PRODUCT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447" ;
--------------------------------------------------------
--  DDL for Index PK_QUERY_ID
--------------------------------------------------------

  CREATE UNIQUE INDEX "HUDDERFOODS"."PK_QUERY_ID" ON "HUDDERFOODS"."CONTACTUS" ("QUERY_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HUDDERFOODS"."PK_REPORT_ID" ON "HUDDERFOODS"."REPORT" ("REPORT_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HUDDERFOODS"."PK_REVIEW_ID" ON "HUDDERFOODS"."REVIEW" ("REVIEW_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447" ;
--------------------------------------------------------
--  DDL for Index PK_SHOP_ID
--------------------------------------------------------

  CREATE UNIQUE INDEX "HUDDERFOODS"."PK_SHOP_ID" ON "HUDDERFOODS"."SHOP" ("SHOP_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447" ;
--------------------------------------------------------
--  DDL for Index PK_TRADER_ID
--------------------------------------------------------

  CREATE UNIQUE INDEX "HUDDERFOODS"."PK_TRADER_ID" ON "HUDDERFOODS"."TRADER" ("TRADER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447" ;
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "HUDDERFOODS"."PK_USER_ID" ON "HUDDERFOODS"."HUDDER_USER" ("USER_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447" ;
--------------------------------------------------------
--  DDL for Index PK_WISHLIST_ID
--------------------------------------------------------

  CREATE UNIQUE INDEX "HUDDERFOODS"."PK_WISHLIST_ID" ON "HUDDERFOODS"."WISHLIST" ("WISHLIST_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447" ;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE TRIGGER "HUDDERFOODS"."ADMIN_TRG" 
...
/
ALTER TRIGGER "HUDDERFOODS"."ADMIN_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger CART_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HUDDERFOODS"."CART_TRG" 
...
/
ALTER TRIGGER "HUDDERFOODS"."CART_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger CATEGORY_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HUDDERFOODS"."CATEGORY_TRG" 
...
/
ALTER TRIGGER "HUDDERFOODS"."CATEGORY_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger CONTACT_ID_TRIGGER
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HUDDERFOODS"."CONTACT_ID_TRIGGER" 
...
/
ALTER TRIGGER "HUDDERFOODS"."CONTACT_ID_TRIGGER" ENABLE;
--------------------------------------------------------
--  DDL for Trigger CUSTOMER_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HUDDERFOODS"."CUSTOMER_TRG" 
...
/
ALTER TRIGGER "HUDDERFOODS"."CUSTOMER_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger DISCOUNT_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HUDDERFOODS"."DISCOUNT_TRG" 
...
/
ALTER TRIGGER "HUDDERFOODS"."DISCOUNT_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger ORDER_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HUDDERFOODS"."ORDER_TRG" 
...
/
ALTER TRIGGER "HUDDERFOODS"."ORDER_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger PAYMENT_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HUDDERFOODS"."PAYMENT_TRG" 
...
/
ALTER TRIGGER "HUDDERFOODS"."PAYMENT_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger PRODUCT_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HUDDERFOODS"."PRODUCT_TRG" 
...
/
ALTER TRIGGER "HUDDERFOODS"."PRODUCT_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger REPORT_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HUDDERFOODS"."REPORT_TRG" 
...
/
ALTER TRIGGER "HUDDERFOODS"."REPORT_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger REVIEW_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HUDDERFOODS"."REVIEW_TRG" 
...
/
ALTER TRIGGER "HUDDERFOODS"."REVIEW_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger SHOP_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HUDDERFOODS"."SHOP_TRG" 
...
/
ALTER TRIGGER "HUDDERFOODS"."SHOP_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger SLOT_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HUDDERFOODS"."SLOT_TRG" 
...
/
ALTER TRIGGER "HUDDERFOODS"."SLOT_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TRADER_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HUDDERFOODS"."TRADER_TRG" 
...
/
ALTER TRIGGER "HUDDERFOODS"."TRADER_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger USER_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HUDDERFOODS"."USER_TRG" 
...
/
ALTER TRIGGER "HUDDERFOODS"."USER_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger WISHLIST_TRG
--------------------------------------------------------

  CREATE OR REPLACE TRIGGER "HUDDERFOODS"."WISHLIST_TRG" 
...
/
ALTER TRIGGER "HUDDERFOODS"."WISHLIST_TRG" ENABLE;
--------------------------------------------------------
--  DDL for Trigger ADMIN_TRG
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE PACKAGE "HUDDERFOODS"."SAMPLE_DATA_PKG" as
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE PACKAGE "HUDDERFOODS"."SAMPLE_PKG" is
    --
...
/
GRANT EXECUTE ON "APEX_190200"."WWV_FLOW_GLOBAL" TO PUBLIC;
--------------------------------------------------------
--  DDL for Package SAMPLE_PKG
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE PACKAGE BODY "HUDDERFOODS"."SAMPLE_DATA_PKG" as
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE PACKAGE BODY "HUDDERFOODS"."SAMPLE_PKG" as
    --
    -- Error Handling function
    --
    function demo_error_handling (
...
--------------------------------------------------------
--  DDL for Synonymn APEX_ERROR
--------------------------------------------------------

  CREATE OR REPLACE PUBLIC SYNONYM "APEX_ERROR" FOR "APEX_190200"."WWV_FLOW_ERROR_API";
--------------------------------------------------------
...
--------------------------------------------------------
--  DDL for Synonymn WWV_FLOW_API
--------------------------------------------------------

  CREATE OR REPLACE PUBLIC SYNONYM "WWV_FLOW_API" FOR "APEX_190200"."WWV_FLOW_API";
--------------------------------------------------------
--  DDL for Synonymn APEX_APPLICATION_GLOBAL
--------------------------------------------------------

  CREATE OR REPLACE PUBLIC SYNONYM "APEX_APPLICATION_GLOBAL" FOR "APEX_190200"."WWV_FLOW_GLOBAL";
--------------------------------------------------------
--  DDL for Synonymn APEX_UTIL
--------------------------------------------------------

  CREATE OR REPLACE PUBLIC SYNONYM "APEX_UTIL" FOR "APEX_190200"."HTMLDB_UTIL";
--------------------------------------------------------
--  Constraints for Table ADMIN
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."ADMIN" ADD CONSTRAINT "PK_ADMIN_ID" PRIMARY KEY ("ADMIN_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447"  ENABLE;
  ALTER TABLE "HUDDERFOODS"."ADMIN" MODIFY ("ADMIN_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table CART
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."CART" ADD CONSTRAINT "PK_CART_ID" PRIMARY KEY ("CART_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447"  ENABLE;
  ALTER TABLE "HUDDERFOODS"."CART" MODIFY ("ORDER_PRODUCT_ID" NOT NULL ENABLE);
  ALTER TABLE "HUDDERFOODS"."CART" MODIFY ("CUSTOMER_ID" NOT NULL ENABLE);
  ALTER TABLE "HUDDERFOODS"."CART" MODIFY ("CART_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table CART_ITEM
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."CART_ITEM" MODIFY ("PRODUCT_ID" NOT NULL ENABLE);
  ALTER TABLE "HUDDERFOODS"."CART_ITEM" MODIFY ("CART_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table COLLECTION_SLOT
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."COLLECTION_SLOT" ADD CONSTRAINT "PK_COLLECTION_SLOT" PRIMARY KEY ("SLOT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447"  ENABLE;
  ALTER TABLE "HUDDERFOODS"."COLLECTION_SLOT" MODIFY ("SLOT_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table CONTACTUS
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."CONTACTUS" ADD CONSTRAINT "PK_QUERY_ID" PRIMARY KEY ("QUERY_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447"  ENABLE;
  ALTER TABLE "HUDDERFOODS"."CONTACTUS" MODIFY ("QUERY_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table CUSTOMER
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."CUSTOMER" ADD CONSTRAINT "PK_CUSTOMER_ID" PRIMARY KEY ("CUSTOMER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447"  ENABLE;
  ALTER TABLE "HUDDERFOODS"."CUSTOMER" MODIFY ("CUSTOMER_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table DISCOUNT
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."DISCOUNT" ADD CONSTRAINT "PK_DISCOUNT_ID" PRIMARY KEY ("DISCOUNT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447"  ENABLE;
  ALTER TABLE "HUDDERFOODS"."DISCOUNT" MODIFY ("PRODUCT_ID" NOT NULL ENABLE);
  ALTER TABLE "HUDDERFOODS"."DISCOUNT" MODIFY ("DISCOUNT_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table HUDDER_USER
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."HUDDER_USER" ADD CONSTRAINT "PK_USER_ID" PRIMARY KEY ("USER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447"  ENABLE;
  ALTER TABLE "HUDDERFOODS"."HUDDER_USER" MODIFY ("USER_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table ORDER_PRODUCT
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."ORDER_PRODUCT" ADD CONSTRAINT "PK_ORDER_PRODUCT_ID" PRIMARY KEY ("ORDER_PRODUCT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447"  ENABLE;
  ALTER TABLE "HUDDERFOODS"."ORDER_PRODUCT" MODIFY ("CART_ID" NOT NULL ENABLE);
  ALTER TABLE "HUDDERFOODS"."ORDER_PRODUCT" MODIFY ("SLOT_ID" NOT NULL ENABLE);
  ALTER TABLE "HUDDERFOODS"."ORDER_PRODUCT" MODIFY ("ORDER_PRODUCT_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table PAYMENT
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."PAYMENT" ADD CONSTRAINT "PK_PAYMENT_ID" PRIMARY KEY ("PAYMENT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447"  ENABLE;
  ALTER TABLE "HUDDERFOODS"."PAYMENT" MODIFY ("ORDER_PRODUCT_ID" NOT NULL ENABLE);
  ALTER TABLE "HUDDERFOODS"."PAYMENT" MODIFY ("CUSTOMER_ID" NOT NULL ENABLE);
  ALTER TABLE "HUDDERFOODS"."PAYMENT" MODIFY ("PAYMENT_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table PRODUCT
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."PRODUCT" ADD CONSTRAINT "PK_PRODUCT_ID" PRIMARY KEY ("PRODUCT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447"  ENABLE;
  ALTER TABLE "HUDDERFOODS"."PRODUCT" MODIFY ("CATEGORY_ID" NOT NULL ENABLE);
  ALTER TABLE "HUDDERFOODS"."PRODUCT" MODIFY ("PRODUCT_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table PRODUCT_CATEGORY
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."PRODUCT_CATEGORY" ADD CONSTRAINT "PK_CATEGORY_ID" PRIMARY KEY ("CATEGORY_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447"  ENABLE;
  ALTER TABLE "HUDDERFOODS"."PRODUCT_CATEGORY" MODIFY ("CATEGORY_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table PRODUCT_REPORT
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."PRODUCT_REPORT" MODIFY ("PRODUCT_ID" NOT NULL ENABLE);
  ALTER TABLE "HUDDERFOODS"."PRODUCT_REPORT" MODIFY ("REPORT_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table REPORT
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."REPORT" ADD CONSTRAINT "PK_REPORT_ID" PRIMARY KEY ("REPORT_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447"  ENABLE;
  ALTER TABLE "HUDDERFOODS"."REPORT" MODIFY ("PRODUCT_ID" NOT NULL ENABLE);
  ALTER TABLE "HUDDERFOODS"."REPORT" MODIFY ("REPORT_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table REVIEW
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."REVIEW" MODIFY ("CUSTOMER_ID" NOT NULL ENABLE);
  ALTER TABLE "HUDDERFOODS"."REVIEW" MODIFY ("ORDER_ID" NOT NULL ENABLE);
  ALTER TABLE "HUDDERFOODS"."REVIEW" ADD CONSTRAINT "PK_REVIEW_ID" PRIMARY KEY ("REVIEW_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447"  ENABLE;
  ALTER TABLE "HUDDERFOODS"."REVIEW" MODIFY ("PRODUCT_ID" NOT NULL ENABLE);
  ALTER TABLE "HUDDERFOODS"."REVIEW" MODIFY ("REVIEW_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table SHOP
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."SHOP" ADD CONSTRAINT "PK_SHOP_ID" PRIMARY KEY ("SHOP_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447"  ENABLE;
  ALTER TABLE "HUDDERFOODS"."SHOP" MODIFY ("SHOP_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table TRADER
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."TRADER" ADD CONSTRAINT "PK_TRADER_ID" PRIMARY KEY ("TRADER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447"  ENABLE;
  ALTER TABLE "HUDDERFOODS"."TRADER" MODIFY ("TRADER_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table WISHLIST
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."WISHLIST" ADD CONSTRAINT "PK_WISHLIST_ID" PRIMARY KEY ("WISHLIST_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "APEX_1500846206436447"  ENABLE;
  ALTER TABLE "HUDDERFOODS"."WISHLIST" MODIFY ("CUSTOMER_ID" NOT NULL ENABLE);
  ALTER TABLE "HUDDERFOODS"."WISHLIST" MODIFY ("WISHLIST_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Constraints for Table WISHLIST_ITEM
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."WISHLIST_ITEM" MODIFY ("PRODUCT_ID" NOT NULL ENABLE);
  ALTER TABLE "HUDDERFOODS"."WISHLIST_ITEM" MODIFY ("WISHLIST_ID" NOT NULL ENABLE);
--------------------------------------------------------
--  Ref Constraints for Table ADMIN
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."ADMIN" ADD CONSTRAINT "FK_ADMIN_ID" FOREIGN KEY ("USER_ID")
	  REFERENCES "HUDDERFOODS"."HUDDER_USER" ("USER_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CART
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."CART" ADD CONSTRAINT "FK_CUSTOMER_CART_ID" FOREIGN KEY ("CUSTOMER_ID")
	  REFERENCES "HUDDERFOODS"."CUSTOMER" ("CUSTOMER_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CART_ITEM
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."CART_ITEM" ADD CONSTRAINT "FK_CART_ITEM_ID" FOREIGN KEY ("CART_ID")
	  REFERENCES "HUDDERFOODS"."CART" ("CART_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "HUDDERFOODS"."CART_ITEM" ADD CONSTRAINT "FK_PRODUCT_CART_ID" FOREIGN KEY ("PRODUCT_ID")
	  REFERENCES "HUDDERFOODS"."PRODUCT" ("PRODUCT_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table COLLECTION_SLOT
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."COLLECTION_SLOT" ADD CONSTRAINT "FK_ORDER_PRODUCT_ID" FOREIGN KEY ("ORDER_PRODUCT_ID")
	  REFERENCES "HUDDERFOODS"."ORDER_PRODUCT" ("ORDER_PRODUCT_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table CUSTOMER
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."CUSTOMER" ADD CONSTRAINT "FK_CUSTOMER_ID" FOREIGN KEY ("USER_ID")
	  REFERENCES "HUDDERFOODS"."HUDDER_USER" ("USER_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table DISCOUNT
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."DISCOUNT" ADD CONSTRAINT "FK_PRODUCT_DISCOUNT_ID" FOREIGN KEY ("PRODUCT_ID")
	  REFERENCES "HUDDERFOODS"."PRODUCT" ("PRODUCT_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table ORDER_DETAILS
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."ORDER_DETAILS" ADD CONSTRAINT "FK_ORDER_PRODUCT_DETAILS_ID" FOREIGN KEY ("ORDER_PRODUCT_ID")
	  REFERENCES "HUDDERFOODS"."ORDER_PRODUCT" ("ORDER_PRODUCT_ID") ENABLE;
  ALTER TABLE "HUDDERFOODS"."ORDER_DETAILS" ADD CONSTRAINT "FK_PRODUCT_DETAILS_ID" FOREIGN KEY ("PRODUCT_ID")
	  REFERENCES "HUDDERFOODS"."PRODUCT" ("PRODUCT_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "HUDDERFOODS"."ORDER_DETAILS" ADD CONSTRAINT "FK_TRADER_USER_ID" FOREIGN KEY ("TRADER_USER_ID")
	  REFERENCES "HUDDERFOODS"."HUDDER_USER" ("USER_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table ORDER_PRODUCT
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."ORDER_PRODUCT" ADD CONSTRAINT "FK_CART_ID" FOREIGN KEY ("CART_ID")
	  REFERENCES "HUDDERFOODS"."CART" ("CART_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PAYMENT
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."PAYMENT" ADD CONSTRAINT "FK_PAYMENT_CUSTOMER_ID" FOREIGN KEY ("CUSTOMER_ID")
	  REFERENCES "HUDDERFOODS"."CUSTOMER" ("CUSTOMER_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PRODUCT
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."PRODUCT" ADD CONSTRAINT "FK_USER_ID" FOREIGN KEY ("USER_ID")
	  REFERENCES "HUDDERFOODS"."HUDDER_USER" ("USER_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table PRODUCT_REPORT
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."PRODUCT_REPORT" ADD CONSTRAINT "FK_PRODUCT_ID" FOREIGN KEY ("PRODUCT_ID")
	  REFERENCES "HUDDERFOODS"."PRODUCT" ("PRODUCT_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "HUDDERFOODS"."PRODUCT_REPORT" ADD CONSTRAINT "FK_REPORT_ID" FOREIGN KEY ("REPORT_ID")
	  REFERENCES "HUDDERFOODS"."REPORT" ("REPORT_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table REPORT
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."REPORT" ADD CONSTRAINT "FK_REPORT_PRODUCT_ID" FOREIGN KEY ("PRODUCT_ID")
	  REFERENCES "HUDDERFOODS"."PRODUCT" ("PRODUCT_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "HUDDERFOODS"."REPORT" ADD CONSTRAINT "FK_REPORT_USER_ID" FOREIGN KEY ("USER_ID")
	  REFERENCES "HUDDERFOODS"."HUDDER_USER" ("USER_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table REVIEW
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."REVIEW" ADD CONSTRAINT "FK_REVIEW_CUSTOMER_ID" FOREIGN KEY ("CUSTOMER_ID")
	  REFERENCES "HUDDERFOODS"."CUSTOMER" ("CUSTOMER_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "HUDDERFOODS"."REVIEW" ADD CONSTRAINT "FK_REVIEW_PRODUCT_ID" FOREIGN KEY ("PRODUCT_ID")
	  REFERENCES "HUDDERFOODS"."PRODUCT" ("PRODUCT_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "HUDDERFOODS"."REVIEW" ADD CONSTRAINT "FK_REVIEW_USER_ID" FOREIGN KEY ("USER_ID")
	  REFERENCES "HUDDERFOODS"."HUDDER_USER" ("USER_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table SHOP
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."SHOP" ADD CONSTRAINT "FK_SHOP_USER_ID" FOREIGN KEY ("USER_ID")
	  REFERENCES "HUDDERFOODS"."HUDDER_USER" ("USER_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table TRADER
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."TRADER" ADD CONSTRAINT "FK_TRADER_ID" FOREIGN KEY ("USER_ID")
	  REFERENCES "HUDDERFOODS"."HUDDER_USER" ("USER_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table WISHLIST
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."WISHLIST" ADD CONSTRAINT "FK_CUSTOMER_WISHLIST_ID" FOREIGN KEY ("CUSTOMER_ID")
	  REFERENCES "HUDDERFOODS"."CUSTOMER" ("CUSTOMER_ID") ON DELETE CASCADE ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table WISHLIST_ITEM
--------------------------------------------------------

  ALTER TABLE "HUDDERFOODS"."WISHLIST_ITEM" ADD CONSTRAINT "FK_PRODUCT_WISHLIST_ID" FOREIGN KEY ("PRODUCT_ID")
	  REFERENCES "HUDDERFOODS"."PRODUCT" ("PRODUCT_ID") ON DELETE CASCADE ENABLE;
  ALTER TABLE "HUDDERFOODS"."WISHLIST_ITEM" ADD CONSTRAINT "FK_WISHLIST_ITEM_ID" FOREIGN KEY ("WISHLIST_ID")
	  REFERENCES "HUDDERFOODS"."WISHLIST" ("WISHLIST_ID") ON DELETE CASCADE ENABLE;
