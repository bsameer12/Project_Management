...
<body>
    ...
    <form>
        ...
        <div class="form-group">
            ...
            <input type="text" id="company-registration-no" name="company-registration-no" placeholder="Enter your Company Registration No" required>
        </div>
        <div class="form-group">
            <label for="shop-description">Shop Description</label>
            <textarea id="shop-description" name="shop-description" placeholder="Enter your Shop Description" required></textarea>
        </div>
        <div class="form-group">
